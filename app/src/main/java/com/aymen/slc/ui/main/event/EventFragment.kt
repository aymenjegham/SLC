package com.aymen.slc.ui.main.event
...
import com.aymen.slc.databinding.FragmentEventBinding
...
class EventFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val binding =
            FragmentEventBinding.inflate(layoutInflater, container, false)
    ...
    private fun bind(binding: FragmentEventBinding) {
    ...
    override fun navigate(navigationTo: Navigation) {
        when (navigationTo) {
            is Navigation.ToLogin -> findNavController().navigate(EventFragmentDirections.toLogin())
        }
    }
}