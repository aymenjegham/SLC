package com.aymen.slc.ui.main.conference
...
import com.aymen.slc.databinding.FragmentConferenceBinding
...
class ConferenceFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val binding =
            FragmentConferenceBinding.inflate(layoutInflater, container, false)
    ...
    private fun bind(binding: FragmentConferenceBinding) {
        binding.lifecycleOwner = viewLifecycleOwner
        binding.viewModel = viewModel

        registerConferenceObservers()

    }

    private fun registerConferenceObservers() {
    ...
    override fun navigate(navigationTo: Navigation) {
        when (navigationTo) {
            is Navigation.ToLogin -> findNavController().navigate(ConferenceFragmentDirections.toLogin())
        }
    }
}